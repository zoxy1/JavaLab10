...
public class Employee {
	...
	public void setPosition(String position) {
		if (position.contains("0") || position.contains("1") || position.contains("2") || position.contains("3") || position.contains("4") || position.contains("5") || position.contains("6") || position.contains("7") || position.contains("8")
				|| position.contains("9")) {
